    ...
    <div className="min-h-screen bg-white pt-24 pb-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          <div className="bg-[--pk-gray-soft] p-8 rounded-2xl">
        ...
        <div className="space-y-12">
          <section>
            <h2 className="text-2xl font-bold text-[--secondary] mb-6 flex items-center">
              <CheckCircle className="text-[--pk-red] mr-3" />
              Community Guidelines
            </h2>
            <div className="space-y-4 text-gray-700">
              <p>
                <strong>Be Respectful:</strong> Treat all members with respect
                and professional courtesy. Harassment or abusive language is not
                tolerated.
              </p>
              <p>
                <strong>Honesty is Key:</strong> Be accurate in your service
                descriptions and fair in your pricing.
              </p>
              <p>
                <strong>Deliver on Promises:</strong> If you agree to provide a
                service, ensure you deliver it to the best of your ability and
                on time.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <button className="bg-[--pk-slate] text-white px-6 py-3 rounded-lg font-medium hover:bg-slate-800 transition-colors">
              Report an Issue
            </button>
          </section>
        </div>
